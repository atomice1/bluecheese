...
#ifndef CLIAPPLICATIONFACTORY_H
#define CLIAPPLICATIONFACTORY_H

#include <QCommandLineOption>
#include <applicationfactorybase.h>

class CliApplicationBase;

class CliApplicationFactory : public ApplicationFactoryBase
{
public:
...
private:
    ...
    QCommandLineOption m_addressOption;
    QCommandLineOption m_getFenOption;
    QCommandLineOption m_sendFenOption;
};

#endif // CLIAPPLICATIONFACTORY_H
